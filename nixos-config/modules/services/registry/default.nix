...
let
  ...
  services = {
    dashboard = { port = 3005; path = "/"; name = "Unified Dashboard"; description = "Service monitoring and management"; healthCheck = "/api/health"; icon = "🏠"; };
    ...
    fileManager = { port = 8082; path = "/files"; name = "File Manager"; description = "Web-based file management"; healthCheck = "/health"; icon = "📁"; };
  };
